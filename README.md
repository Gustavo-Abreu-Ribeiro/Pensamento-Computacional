...
Paralelamente a essa evolução tecnológica, desenvolveu-se o pensamento computacional, uma abordagem baseada em lógica, organização e estruturação de problemas, que não se limita ao uso de computadores, mas pode ser aplicada em diversas situações do cotidiano.
...
Para facilitar a resolução, foi aplicada a técnica de decomposição, que consiste em dividir um problema complexo em partes menores e mais gerenciáveis.
